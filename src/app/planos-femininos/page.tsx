...
export default function PlanosFemininosPage() {
    ...
    <div className="min-h-screen bg-[#0D0D0D] flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border mb-6 border-[#FF69B4]/30"
          >
            <Sparkles className="w-4 h-4 text-[#FF69B4]" />
            <span className="text-sm text-white/80">Planos Femininos</span>
            {isAdmin && (
            ...
            >
              {key === 'anual' && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div
                    className="bg-gradient-to-r from-[#FF69B4] to-[#FF1493] px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-1 text-white"
                  >
              ...
              <div className="text-center mb-6">
                ...
                {plan.savings && (
                  <div className="text-sm font-semibold mt-2 text-[#FF69B4]">
                    {plan.savings}
                  </div>
                )}
              </div>
              ...
              <div className="space-y-3 mb-8">
                {plan.features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <Check className="w-5 h-5 flex-shrink-0 text-[#FF69B4]" />
              ...
              <button
                ...
                className="w-full py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 bg-white text-[#FF69B4]"
              >
                Escolher {plan.name}
              </button>
            </div>
