...
export default function PhotosPage() {
  ...
  const handleContinue = () => {
    if (allPhotosUploaded) {
      // Redireciona para a página de análise correta baseado no gênero
      if (quizData.gender === 'masculino') {
        router.push('/analisando-masculino');
      } else {
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-sm text-white/80">Análise Visual</span>
          </div>

          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            Tire fotos do seu cabelo
          </h1>

          <p className="text-white/60 text-lg">
            Precisamos de 3 fotos para nossa IA analisar seu cabelo e criar a rotina perfeita.
          </p>
        </div>
