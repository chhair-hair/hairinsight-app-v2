      ...
      <div className="container mx-auto px-4 py-16 text-center">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-600 delay-600">
          <button
            ...
            className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-[#9B59B6] font-bold rounded-full hover:shadow-2xl transition-all duration-300 hover:scale-105 uppercase"
          >
