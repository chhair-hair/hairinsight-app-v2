...
export default function PreResultadoMasculino() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-white pb-20">
      ...
      {/* Seção Informativa sobre o App */}
      <div className="container mx-auto px-4 sm:px-6 mb-12 sm:mb-16">
        <div className="max-w-4xl mx-auto">
          <div className="animate-in fade-in duration-600 bg-gradient-to-br from-white/10 via-white/5 to-transparent border border-white/10 rounded-3xl p-8 sm:p-12 backdrop-blur-sm shadow-2xl">
            {/* Título Principal */}
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-4">
                <Sparkles className="w-5 h-5" style={{ color: colors.primary }} />
                <span className="text-sm font-semibold text-white/90">Tecnologia de Ponta para Seu Cabelo</span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white via-white to-white/80 bg-clip-text text-transparent">
                Seu Cabelo Perfeito Começa Aqui
              </h2>
              <p className="text-base sm:text-lg text-white/70 leading-relaxed">
                Descubra o poder de uma análise personalizada com inteligência artificial avançada
              </p>
            </div>
            ...
            <div className="space-y-6 mb-8">
              {/* Benefício 1 */}
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-2 text-white">Rotina Capilar Personalizada</h3>
                  <p className="text-sm sm:text-base text-white/70 leading-relaxed">
                    Receba uma rotina de cuidados <span className="font-semibold text-white">100% adaptada</span> ao seu tipo de cabelo, necessidades e estilo de vida. Produtos certos, na ordem certa, nos momentos certos.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-2 text-white">Análise de Formato de Rosto</h3>
                  <p className="text-sm sm:text-base text-white/70 leading-relaxed">
                    Nossa IA identifica <span className="font-semibold text-white">seu formato de rosto</span> e recomenda os cortes que mais <span className="font-semibold text-white">valorizam suas características</span>, seguindo as tendências atuais e princípios de harmonia facial.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-2 text-white">Harmonização de Cor Perfeita</h3>
                  <p className="text-sm sm:text-base text-white/70 leading-relaxed">
                    Análise completa da <span className="font-semibold text-white">relação entre tom de pele e cor do cabelo</span>, garantindo que você escolha tonalidades que realçam sua beleza natural e aumentam sua autoestima.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold mb-2 text-white">Acompanhamento de Tendências</h3>
                  <p className="text-sm sm:text-base text-white/70 leading-relaxed">
                    Fique por dentro dos <span className="font-semibold text-white">cortes e estilos masculinos mais modernos</span>, adaptados especialmente para você, sem perder sua essência e personalidade.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* CTA Persuasivo */}
            <div className="text-center p-6 rounded-2xl border-2 border-dashed" style={{ borderColor: `${colors.primary}40`, backgroundColor: `${colors.primary}10` }}>
              <p className="text-base sm:text-lg font-semibold mb-2" style={{ color: colors.primary }}>
                ✨ Milhares de homens já transformaram seus cabelos
              </p>
              <p className="text-sm text-white/70">
                Junte-se a quem decidiu investir em si mesmo e descobrir seu melhor visual
              </p>
            </div>
          </div>
        </div>
