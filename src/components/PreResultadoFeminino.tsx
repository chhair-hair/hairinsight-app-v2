          ...
          <div className="animate-in fade-in duration-600 bg-gradient-to-br from-white/10 via-white/5 to-transparent border border-white/10 rounded-3xl p-8 sm:p-12 backdrop-blur-sm shadow-2xl">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-white/70 leading-relaxed">
                    Fique por dentro dos <span className="font-semibold text-white">cortes e estilos mais modernos</span>, adaptados especialmente para você, sem perder sua essência e personalidade única.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl border-2 border-dashed" style={{ borderColor: `${colors.primary}40`, backgroundColor: `${colors.primary}10` }}>
              <p className="text-base sm:text-lg font-semibold mb-2" style={{ color: colors.primary }}>
                ✨ Milhares de pessoas já transformaram seus cabelos
              </p>
